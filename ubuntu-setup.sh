...
sudo apt-get install -y vim git curl python python3 python-pip python3-pip terminator nodejs-legacy npm mongodb droopy zip unzip p7zip* gparted rar gcc make perl linux-headers*
